...
type Querier interface {
	...
	GetSimilarKBArticles(ctx context.Context, arg GetSimilarKBArticlesParams) ([]GetSimilarKBArticlesRow, error)
	...
	UpdateTicketAIState(ctx context.Context, arg UpdateTicketAIStateParams) error
